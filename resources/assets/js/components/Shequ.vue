        ...
        <div class="panel panel-default">
            ...
            <div class="panel-heading">
                ...
                <ul class="list-inline topic-filter">
                    <li class="popover-with-html" data-content="最后回复排序" data-original-title="" title=""><a href="http://phphub5.app/topics?filter=default">社区</a></li>
    ...
    export default {
        ...
        methods:{
            fetchData(){
                var _this = this;
                this.loading = true;
                window.axios.get(baseUrl+"/api/topic?include=category,last_reply_user,user,replies&%20filters=excellent&per_page=20&page=1").then(function (response) {
